...
const DetectionHistory = () => {
    ...
    useEffect(() => {
        const fetchHistories = async () => {
            setLoading(true);
            try {
                const response = await aiApi.get(endpoints['image-recognition-service']['get-histories'](info.id));
        ...
        <View style={styles.headerContainer}>
            <View style={styles.headerContent}>
                <View style={styles.headerIconContainer}>
                    <Ionicons name="camera-outline" size={24} color={COLORS.yellowIconColor} />
                </View>
            ...
            {histories.length === 0 ? (
                <View style={styles.emptyContainer}>
                    <View style={styles.emptyIconContainer}>
                        <Ionicons name="images-outline" size={64} color={COLORS.yellowIconColor} />
                    </View>
                    <Text style={styles.emptyText}>Chưa có lịch sử nhận diện</Text>
                    <Text style={styles.emptySubText}>Bắt đầu sử dụng camera để nhận diện</Text>
                </View>
            ) : (
                <FlatList
                    data={histories}
